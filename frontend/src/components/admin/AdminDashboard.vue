    ...
    <div class="admin-content">
          ...
          <div class="docs-header">
            ...
            <div class="docs-search">
              <input
                ...
                @input="loadDocuments"
              />
              <button class="refresh-btn" @click="loadDocuments" aria-label="Refresh">↻</button>
            </div>
          </div>
      ...
      <div v-else-if="activeTab === 'clusters'" class="tab-content">
        <div class="clusters-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadQueryClusters" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'failures'" class="tab-content">
        <div class="failures-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadFailureAnalysis" aria-label="Refresh">↻</button>
          </div>
        ...
        <div class="viz-section">
          <div class="section-header">
            ...
            <div class="viz-controls">
              ...
              <button class="refresh-btn" @click="loadEmbeddingViz" aria-label="Refresh">↻</button>
            </div>
          </div>
      ...
      <div v-else-if="activeTab === 'quality'" class="tab-content">
        <div class="quality-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadChunkQuality" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'alerts'" class="tab-content">
        <div class="alerts-section">
          <div class="section-header">
            <h3>🔔 Smart Alerts</h3>
            <button class="refresh-btn" @click="loadAlerts" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'capacity'" class="tab-content">
        <div class="capacity-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadCapacityForecast" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'selfheal'" class="tab-content">
        <div class="selfheal-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadSelfHealing" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'cost'" class="tab-content">
        <div class="cost-section">
          <div class="section-header">
            <h3>💰 Cost Analysis</h3>
            <button class="refresh-btn" @click="loadCostAnalysis" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'users'" class="tab-content">
        <div class="users-section">
          <div class="section-header">
            <h3>👥 User Behavior</h3>
            <button class="refresh-btn" @click="loadUserBehavior" aria-label="Refresh">↻</button>
          </div>
      ...
      <div v-else-if="activeTab === 'health'" class="tab-content">
        <div class="health-section">
          <div class="section-header">
            ...
            <button class="refresh-btn" @click="loadHealthScore" aria-label="Refresh">↻</button>
          </div>
